...
S {}
E {}
N 130 90 130 110 { lab=ground}
N 130 110 130 140 { lab=ground}
N 130 60 220 60 { lab=ground}
N 220 60 220 120 { lab=ground}
N 130 120 220 120 { lab=ground}
N 130 -10 130 30 { lab=#net1}
N 350 110 350 140 { lab=ground}
N 350 -10 350 50 { lab=do}
N -50 -10 -10 -10 { lab=din}
N 350 -10 410 -10 { lab=do}
N 50 60 90 60 { lab=dB}
N 130 140 350 140 { lab=ground}
N 240 140 240 160 { lab=ground}
N 50 -10 130 -10 { lab=#net1}
N 130 -10 200 -10 { lab=#net1}
N 260 -10 350 -10 { lab=do}
N 230 10 230 80 { lab=ground}
N 220 80 230 80 { lab=ground}
...
C {/home/wisla/sky130_skel/xschem_sky130/sky130_fd_pr/res_xhigh_po_0p35.sym} 230 -10 3 0 {name=R1
W=0.35
L=18.6
